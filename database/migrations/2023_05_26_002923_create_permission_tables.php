...
class CreatePermissionTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($tableNames['user_has_permissions'], function (Blueprint $table) use ($tableNames, $columnNames, $teams) {
            ...
            if ($teams) {
                ...
                $table->index($columnNames['team_foreign_key'], 'user_has_permissions_team_foreign_key_index');
        ...
        Schema::create($tableNames['user_has_roles'], function (Blueprint $table) use ($tableNames, $columnNames, $teams) {
