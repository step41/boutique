    ...
    Slick = (function() {
        ...
        function Slick(element, settings) {
            ...
            _.defaults = {
                ...
                arrows: true,
                asNavFor: null,
                prevArrow: '<button type="button" data-role="none" class="icon icon-chevron-left slick-prev">Prev</button>',
                nextArrow: '<button type="button" data-role="none" class="icon icon-chevron-right slick-next">Next</button>',
                autoplay: false,
                autoplaySpeed: 3000,
                centerMode: false,
                centerPadding: '50px',
