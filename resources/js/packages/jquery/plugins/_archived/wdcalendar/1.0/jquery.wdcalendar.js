...
; (function($) {
    ...
    $.fn.bcalendar = function(option) {
        ...
        function BuildDayEvent(theme, e, index) {
            var p = { bdcolor: theme[0], bgcolor2: theme[0], bgcolor1: theme[2], width: "70%", icon: "", title: "", eventid: "", data: "" };
        ...
        function populate() {
            ...
            if (option.url && option.url != "") {
                ...
                var param = [
                { name: "content_event_showdate", value: dateFormat.call(option.showday, i18n.xgcalendar.dateformat.fulldayvalue) },
                { name: "content_event_viewtype", value: option.view },
				 { name: "content_event_timezone", value: zone }
                ];
                if (option.extParam) {
        ...
        function quickd(type) {
            ...
            var param = [{ "name": "eventid", value: calid },
        ...
        function dayshow(e, data) {
            ...
            if (data != null) {
                if (option.quickDeleteUrl != "" && data[8] == 1 && option.readonly != true) {
                    var csbuddle = '<div id="bbit-cs-buddle" style="width: 400px;visibility:hidden;" class="bubble"><table class="bubble-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="bubble-cell-side"><div id="tl1" class="bubble-corner"><div class="bubble-sprite bubble-tl"></div></div><td class="bubble-cell-main"><div class="bubble-top"></div><td class="bubble-cell-side"><div id="tr1" class="bubble-corner"><div class="bubble-sprite bubble-tr"></div></div>  <tr><td class="bubble-mid" colSpan="3"><div style="overflow: hidden" id="bubbleContent1"><div><div></div><div class="cb-root"><table class="cb-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><div id="bbit-cs-what"class="textbox-fill-div"></div></div></div></td></tr><tr><td class=cb-value><div id="bbit-cs-buddle-timeshow"></div></td></tr></tbody></table><div class="bbit-cs-split"><input id="bbit-cs-id" type="hidden" value=""/><button type="button" id="event_preview" title="'+ i18n.xgcalendar.click_to_detail + '" class="btnEventPreview"><div class="btnBgIcon"></div></button> &nbsp; <button type="button" id="bbit-cs-editLink" title="'
                    	+ i18n.xgcalendar.update_detail + '" class="btnEventEdit"><div class="btnBgIcon"></div></button> &nbsp; <button type="button" id="bbit-cs-delete" title="'+ i18n.xgcalendar.i_delete + '" class="btnEventDelete"><div class="btnBgIcon"></div></button></div></div></div></div><tr><td><div id="bl1" class="bubble-corner"><div class="bubble-sprite bubble-bl"></div></div><td><div class="bubble-bottom"></div><td><div id="br1" class="bubble-corner"><div class="bubble-sprite bubble-br"></div></div></tr></tbody></table><div id="bubbleClose2" class="bubble-closebutton"></div><div id="prong1" class="prong"><div class=bubble-sprite></div></div></div>';
                    ...
                    if (bud.length == 0) {
                        ...
                        $("#event_preview").click(function(e) {
                            if (!option.ViewCmdhandler) {
                                ...
                                //}
								$("#event_preview").attr('id','event_preview_'+data[0]);
								getRecordPreview(this);
                            }
                            $("#bbit-cs-buddle").css("visibility", "hidden");
                            return false;
                        });
...
//                                }
			                    lbtn.attr('id','event_write_'+data[0]);
								getRecordWrite(this,2);
                            }
                            $("#bbit-cs-buddle").css("visibility", "hidden");
                            return false;
                        });
        ...
        function dayupdate(data, start, end) {
            if (option.quickUpdateUrl != "" && data[8] == 1 && option.readonly != true) {
                ...
                var od = data[3];
                var zone = new Date().getTimezoneOffset() / 60 * -1;
                var param = [{ "name": "eventid", value: id },
							{ "name": "content_event_date_start", value: dateFormat.call(start, i18n.xgcalendar.dateformat.fulldayvalue + " HH:mm") },
							{ "name": "content_event_date_stop", value: dateFormat.call(end, i18n.xgcalendar.dateformat.fulldayvalue + " HH:mm") },
							{ "name": "content_event_timezone", value: zone }
						   ];
                var d;
        ...
        function quickadd(start, end, isallday, pos) {
            ...
            if (buddle.length == 0) {
                var temparr = [];
                temparr.push('<div id="bbit-cal-buddle" style="width: 400px;visibility:hidden;" class="bubble">');
                ...
                temparr.push(i18n.xgcalendar.content, ':</th><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><input id="bbit-cal-what" class="textbox-fill-input input" maxlength="100" /></div></div><div class="cb-example">');
                temparr.push(i18n.xgcalendar.example, '</div></td></tr></tbody></table><input id="bbit-cal-start" type="hidden"/><input id="bbit-cal-end" type="hidden"/><input id="bbit-cal-allday" type="hidden"/><button type="button" id="bbit-cal-quickAddBTN" title="'+ i18n.xgcalendar.create_event + '" class="btnEventAdd"><div class="btnBgIcon"></div></button>');
                //temparr.push('&nbsp; <button type="button" id="bbit-cal-editLink" title="'+ i18n.xgcalendar.update_detail + '" class="btnEventEdit"><div class="btnBgIcon"></div></button>');
                ...
                calbutton.click(function(e) {
                    ...
                    var zone = new Date().getTimezoneOffset() / 60 * -1;
                    var param = [{ "name": "content_title", value: what },
						{ "name": "content_event_date_start", value: datestart },
						{ "name": "content_event_date_stop", value: dateend },
						{ "name": "content_event_allday", value: allday },
						{ "name": "content_event_timezone", value: zone}];
                ...
                switch (d.type) {
                    ...
                    case 2:
                        ...
                        if (diffx > 5 || diffx < -5 || d.lasso) {
                            if (!d.lasso) {
                                d.lasso = $("<div style='z-index: 0; display: block' class='drag-lasso-container'/>");
