...
(function($) {
    ...
    $.jqplot.CanvasOverlay.prototype.removeObject = function(idx) {
        ...
        if (typeof (idx || undefined) == 'number') {
                        ...
                        case 'horizontalLine':
                            ...
                            if (obj.options.y != null) {
                                ...
                                if (obj.options.xmin != null) {
                                    ...
                                    if (typeof (xminoff || undefined) == "number") {
                                        xstart = xaxis.series_u2p(xaxis.min + xminoff);
                                    }
                                    else if (typeof (xminoff || undefined) == "string") {
                                ...
                                if (obj.options.xmax != null) {
                                    ...
                                    if (typeof (xmaxoff || undefined) == "number") {
                                        xstop = xaxis.series_u2p(xaxis.max - xmaxoff);
                                    }
                                    else if (typeof (xmaxoff || undefined) == "string") {
                        ...
                        case 'verticalLine':
                            ...
                            if (obj.options.x != null) {
                                ...
                                if (obj.options.ymin != null) {
                                    ...
                                    if (typeof (yminoff || undefined) == "number") {
                                        ystart = yaxis.series_u2p(yaxis.min - yminoff);
                                    }
                                    else if (typeof (yminoff || undefined) == "string") {
                                ...
                                if (obj.options.ymax != null) {
                                    ...
                                    if (typeof (ymaxoff || undefined) == "number") {
                                        ystop = yaxis.series_u2p(yaxis.max + ymaxoff);
                                    }
                                    else if (typeof (ymaxoff || undefined) == "string") {
