...
(function( factory ) {
	...
	$.widget("mjs.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
		...
		options: {
			...
			collapsedClass: "nestedsortable-collapsed",
			disableNestingClass: "nestedsortable-no-nesting",
			errorClass: "nestedsortable-error",
			expandedClass: "nestedsortable-expanded",
			hoveringClass: "nestedsortable-hovering",
			leafClass: "nestedsortable-leaf",
			disabledClass: "nestedsortable-disabled"
		},
		...
		_create: function() {
			...
			this.element.data("ui-sortable", this.element.data("nestedsortable"));
